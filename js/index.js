            ...
            case 'IcosahedronGeometry':
                if (currentcolor == 0xF66120) {
                    ...
                    if (planetViewed == 2 || planetViewed==3 || planetViewed==4) {
                        ...
                        description.innerHTML = "International Institute of Information Technology, Nuzvid Class of <span>2016</span><br/><a target='_blank' href='https://github.com/gkalyan04/gkalyan04.github.io/blob/master/final_resume.pdf'>Offline Resume</a><br/><br/><div>Click on the other planets to learn more ...<div>";
                ...
                if (currentcolor == 0x26D7E7) {
                    if (planetViewed == 1 || planetViewed==3 || planetViewed==4) {
                        ...
                        subtitle.innerHTML = "All <span>My Stuff</span>.";
                        description.innerHTML = "You can find all my experiments here :  <br/><a target='_blank' href='https://github.com/iamknownstranger?tab=repositories'>My Repositories</a><br/><br/><div>Click on the other planets to learn more ...<div>";
                   ...
                   if (currentcolor == 0xffc12d) {
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==4) {
                        planetViewed = 3;
                        info.innerHTML = '<span id="couleur">Nayanam</span> Project : <a target="_blank" href="https://github.com/iamknownstranger/Project-Nayanam" style="font-size: 22px; color: white;">Github <a> ';
                         document.getElementById('couleur').style.color="#ffc12d";
                        subtitle.innerHTML = "Since <span>August 2019</span>.";
                        description.innerHTML = "A digital automation tool to Save your eyes and Information wisely using Computer Vision<br/><br/><div>Click on the other planets to learn more ...<div>";
